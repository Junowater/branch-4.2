...
function loadData() {
    let savedTeamMembers = localStorage.getItem('rearLine_' + "teamMembers");
    if (savedTeamMembers) {
        try {
    ...
    let savedConstraints = localStorage.getItem('rearLine_' + "constraints");
    if (savedConstraints) {
        try {
    ...
    let savedWorkstations = localStorage.getItem('rearLine_' + "workstations");
    ...
    let savedSchedule = localStorage.getItem('rearLine_' + "schedule");
    if (savedSchedule) {
        try {
    ...
    const savedDisabledQuarters = localStorage.getItem('rearLine_' + "disabledQuarters");
...
function saveData(showAlert = true) {
    localStorage.setItem('rearLine_' + "teamMembers", JSON.stringify(teamMembers));
    localStorage.setItem('rearLine_' + "constraints", JSON.stringify(constraints));
    localStorage.setItem('rearLine_' + "workstations", JSON.stringify(workstations));
    localStorage.setItem('rearLine_' + "schedule", JSON.stringify(schedule));  // <-- Save schedule
    localStorage.setItem('rearLine_' + "disabledQuarters", JSON.stringify(disabledQuarters));
...
function deleteTeamMember(name) {
    if (confirm(`Are you sure you want to delete ${name}? This action cannot be undone.`)) {
        ...
        let savedRotations = localStorage.getItem('rearLine_' + "savedRotations");
        if (savedRotations) {
            ...
            localStorage.setItem('rearLine_' + "savedRotations", JSON.stringify(savedRotations));
...
function resetWeeklyData() {
    localStorage.removeItem('rearLine_' + "savedRotations");
